...
class DisplayRAMP(BasePage):
  ...
  def __init__(self, width, height, page_title, gpp_or_reco, params_to_graph, optional_graph_widget, optional_graph_name):
    ...
    next_ramp_button.setFont(QtGui.QFont("Times", 12, QtGui.QFont.Bold))
    prev_ramp_button.setFont(QtGui.QFont("Times", 12, QtGui.QFont.Bold))
    ...
    optional_graph_button.setFont(QtGui.QFont("Times", 9, QtGui.QFont.Bold))
