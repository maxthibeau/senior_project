...
class EnterRecoHyperparams(BasePage):
  ...
  def __init__(self, width, height, page_title):
    ...
    self.Prh_label.setFont(QtGui.QFont("Times", 10))
    self.Prh_error_label = QtWidgets.QLabel("Error: Prh must be between 0 and 1")
    self.Prh_error_label.setFont(QtGui.QFont("Times", 10))
    ...
    self.Pk_label.setFont(QtGui.QFont("Times", 10))
    self.Pk_error_label = QtWidgets.QLabel("Error: Pk must be between 0 and 1")
    self.Pk_error_label.setFont(QtGui.QFont("Times", 10))
    ...
    prev_button.setFont(QtGui.QFont("Times", 8, QtGui.QFont.Bold))
    ...
    next_button.setFont(QtGui.QFont("Times", 9, QtGui.QFont.Bold))
