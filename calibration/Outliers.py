...
class Outliers:
    ...
    #SavitzkyGolay filter - scipy.signal.savgol_filtermkj(x, window_length, polyorder, deriv=0, delta=1.0, axis=-1, mode='interp', cval=0.0) https://docs.scipy.org/doc/scipy-0.16.1/reference/generated/scipy.signal.savgol_filter.html
